...
const ActiveClockIcon: React.FC<IActiveClockIcon> = ({
	activityValue,
	peopleCount,
	projectsCount,
	slowTimeSpeed,
	...
	return (
		...
		c0,0,0,0,0,0C234.7,377.8,220.9,364,203.9,364L203.9,364z"
			...
			C81.1,387.9,80.8,387.9,80.5,388L80.5,388z"
				...
				<polyline
					className={classes.clock__st16}
					points="379.8,67.1 370.5,53.7 202,53.7 	"
				/>
				...
				<polyline
					className={classes.clock__st17}
					points="107.1,399.3 116.4,386 165.7,386 	"
				/>
				<g>
					<linearGradient
						id="SVGID_19_"
					...
					<polyline
						className={classes.clock__st18}
						points="176.7,413.3 167.4,426.6 106.1,426.6 		"
					/>
				</g>
		...
		c-15.2,0-27.5,12.3-27.5,27.5H178.6z"
				...
				<g>
					...
					<path
						className={classes.clock__st36}
						d="M249.7,384.4c1.7,0,3.4,0,5.1-0.1l0.3,8c-1.8,0.1-3.6,0.1-5.4,0.1V384.4z"
					/>
				...
				<g>
					...
					<polygon
						className={classes.clock__st42}
						points="248.6,338.5 248.6,381.3 250.6,381.3 250.6,338.5 248.6,338.5 		"
					/>
					...
					<polygon
						className={classes.clock__st44}
						points="310,343.5 321,362.4 322.8,361.4 311.9,342.5 310,343.5 		"
					/>
					...
					<polygon
						className={classes.clock__st45}
						points="176.5,112.3 187.4,131.1 189.2,130.1 178.2,111.2 		"
					/>
					...
					<polygon
						className={classes.clock__st46}
						points="355.2,299.1 374.2,310 375.4,308.2 356.3,297.2 355.2,299.1 		"
					/>
					...
					<polygon
						className={classes.clock__st47}
						points="124,165.5 142.9,176.4 144.1,174.7 125.1,163.7 		"
					/>
					...
					<polygon
						className={classes.clock__st50}
						points="356.3,176.4 375.4,165.5 374.2,163.7 355.2,174.7 		"
					/>
					...
					<polygon
						className={classes.clock__st51}
						points="125.1,310 144.1,299.1 142.9,297.2 124,308.2 125.1,310 		"
					/>
					...
					<polygon
						className={classes.clock__st52}
						points="311.9,131.1 322.8,112.3 321,111.2 310,130.1 		"
					/>
					...
					<polygon
						className={classes.clock__st53}
						points="178.2,362.4 189.2,343.5 187.4,342.5 176.5,361.4 178.2,362.4 		"
					/>
					...
					<polygon
						className={classes.clock__st54}
						points="248.6,381.3 250.6,381.3 250.6,338.5 248.6,338.5 248.6,381.3 		"
					/>
					...
					<polygon
						className={classes.clock__st55}
						points="321,362.4 322.8,361.4 311.9,342.5 310,343.5 321,362.4 		"
					/>
					...
					<polygon
						className={classes.clock__st56}
						points="374.2,310 375.4,308.2 356.3,297.2 355.2,299.1 374.2,310 		"
					/>
				...
				c-0.6,0.6-0.7,1.6-0.7,2.9c-0.1,1.1,0.1,2.2,0.7,3.1c0.5,0.6,1.3,1,2.1,1c0.8,0,1.5-0.4,2-1C158.8,234,159,233,159,232L159,232z"
						/>
						<PeopleG count={peopleCount} />
						<ProjectsG count={projectsCount} />
						<ActivityG activity={activityValue} />
					</g>
				</g>
			</g>
			{slowTimeSpeed ? (
