		...
		<section className={styles.contacts}>
			<Container>
				<div className={styles.contacts__inner}>
					...
					<div className={styles.contacts__info}>Разработка web&#8209;приложений любой сложности под ключ</div>
					<div className={styles.contacts__main}>
						<div className={styles.contacts__links}>
							<Card>
								<div className={styles['contacts__links-inner']}>
									<a href="tel:+380507777777" className={styles.link}>
										<svg>
											<use href="#phoneSvg" />
										</svg>
										<span className={styles.link__title}>+38(050)777-77-77</span>
									</a>
									<a href="https://t.me/pavel_i_tel" className={styles.link} target="_blank">
										<svg>
									...
									<a href="mailto:admin@mirosphere.org" className={styles.link}>
										...
										<span className={styles.link__title}>admin@mirosphere.org</span>
									</a>
								</div>
							</Card>
						</div>
						<form className={styles.contacts__form}>
							<Card>
								<div className={styles['contacts__form-inner']}>
									<div className={styles['contacts__form-text']}>Хочу получать обновления о проекте</div>
