				...
				<div className={styles.products__inner}>
					...
					<div className={styles.chess}>
						...
						<div className={styles.chess__info1}>
							<Card>
								Полноценный доступ с мобильных устройств.
								Вы можете управлять своим аккаунтом исключительно с мобильного устройства
							</Card>
						</div>
						<img
							src="/chess/chess5.webp"
							alt="Видео"
							className={styles.chess__img5}
						/>
						<div className={styles.chess__info2}>
							<Card>Жеребьевка на большом экране понятна старикам и детям!</Card>
						</div>
						<img
						...
						<div className={styles.chess__info3}>
							<Card>
								Мы создали простой и продуманный сервис для проведения шахматных соревнований,
								где каждое действие похоже на игру. Вы с лёгкостью сможете управлять шахматным клубом,
								проводить турниры в пару кликов. Алгоритм автоматической жеребьевки,
								информационные экраны, управление присутствием, предварительная регистрация и другие инструменты,
								- всё это направленно на улучшение и упрощение жизни шахматного благородного сообщества!
							</Card>
						</div>
					</div>
				</div>
